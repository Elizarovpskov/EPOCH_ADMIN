...
if (isset($_SESSION['user_id']) and (strpos($_SESSION['user_permissions'], "control") !== false))
{
    ...
    if (file_exists("D:\\arma2\\@dayzcc_config\\".$serverinstance."\\BEC\Log\instance".$serverinstance."\\Chat\\Chat_".date("Y-m-d").".log")) {
        require_once('modules/file.php');
        $say = explode("\n", str_replace("\r", "", last_lines("D:\\arma2\\@dayzcc_config\\".$serverinstance."\\BEC\Log\instance".$serverinstance."\\Chat\\Chat_".date("Y-m-d").".log", 50)));
