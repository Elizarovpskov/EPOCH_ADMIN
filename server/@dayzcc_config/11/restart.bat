...
set BECpath=\@dayzcc_config\11\BattlEye Extended Controls
...
echo ARMA main directory is: "D:\ARMA2\@dayzcc_config\11\"
echo ARMA BEC directory is:  "D:\ARMA2\@dayzcc_config\11\BattlEye Extended Controls"
cd /d "%ARMApath%"
echo Switched to ArmA 2 main directory:
echo %CD%
echo.
echo Killing current running server ...
taskkill /IM arma2oaserver_11.exe
echo.
...
@start @dayzcc_config\11\arma2oaserver_6.exe -beta=Expansion\beta;Expansion\beta\Expansion -mod=@dayz_epoch;@dayzcc -name=Server -config=@dayzcc_config\11\config.cfg -cfg=@dayzcc_config\11\basic.cfg -profiles=@dayzcc_config\11 -port=2302 -cpuCount=2 -maxMem=1468
echo.

:start bec
timeout 30
echo starting BEC again...
cd /d "D:\ARMA2\@dayzcc_config\11\BattlEye Extended Controls"
